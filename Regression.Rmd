...
## Model #3a: Demographic information & Crypto State-Year Variable & interaction of Age_24_or_younger and Crypto State-Year variable
```{r Model #3a: Demographic information & Crypto State-Year Variable & interaction of Age_24_or_younger and Crypto State-Year variable}
...
## Model #3b: Demographic information & Crypto State-Year Variable & interaction of Age_34_or_younger and Crypto State-Year variable
```{r Model #3b: Demographic information & Crypto State-Year Variable & interaction of Age_34_or_younger and Crypto State-Year variable}
...
## Model #3c: Demographic information & Crypto State-Year Variable & interaction of Age_44_or_younger and Crypto State-Year variable
```{r Model #3c: Demographic information & Crypto State-Year Variable & interaction of Age_44_or_younger and Crypto State-Year variable}
...
```{r Model #4: Demographic information & Crypto State-Year Variable & Age-squared variable}
...
## Model #5a: Demographic information & Crypto State-Year Variable & interaction of Age_24_or_younger and Crypto State-Year variable excluding MAIN EFFECT of Age_24_or_younger
```{r Model #5a: Demographic information & Crypto State-Year Variable & Age-squared variable}
...
## Model #5b: Demographic information & Crypto State-Year Variable & interaction of Age_34_or_younger and Crypto State-Year variable excluding MAIN EFFECT of Age_34_or_younger
```{r Model #5b: Demographic information & Crypto State-Year Variable & Age-squared variable}
...
## Model #5c: Demographic information & Crypto State-Year Variable & interaction of Age_44_or_younger and Crypto State-Year variable excluding MAIN EFFECT of Age_44_or_younger
```{r Model #5c: Demographic information & Crypto State-Year Variable & Age-squared variable}
